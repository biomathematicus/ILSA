...
\usepackage{enumitem}
\usepackage{amsmath}   % aligned equations, matrices (Methodology appendix)
...
\usepackage{tcolorbox} % "Key Finding" callout boxes (loaded after graphicx to avoid option clash)
...
% "Key Finding" callout box used to highlight critical results in the report body.
\newtcolorbox{keyfinding}[1][Key Finding]{%
  colback=UTSABlue!6!white, colframe=UTSABlue, coltitle=white,
  fonttitle=\bfseries\sffamily, title={#1}, fontupper=\sffamily,
  boxrule=0.7pt, arc=2.5pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
